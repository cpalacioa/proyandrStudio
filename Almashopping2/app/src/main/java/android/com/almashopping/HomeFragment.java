...
public class HomeFragment extends Fragment {
    ...
    public void onActivityCreated(Bundle state) {
        ...
        connectionProgressDialog = new ProgressDialog(HomeFragment.this.getActivity());
        ...
        gvProductos=(GridView)getView().findViewById(R.id.Grid_productosCajita);
    ...
    AdapterView.OnItemClickListener listenerGridProductos=new AdapterView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            Intent i=new Intent(HomeFragment.this.getActivity().getApplicationContext(),DetalleProducto.class);
    ...
    private class TareaWSListar extends AsyncTask<String,Integer,Boolean> {
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (result)
            {
                gvProductos.setAdapter(new AdaptadorProductos(HomeFragment.this.getActivity(),productos));
